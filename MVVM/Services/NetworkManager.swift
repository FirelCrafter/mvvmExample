...
final class NetworkManager {
    ...
    private static let baseAddress: URL = URL(string: "https://jsonplaceholder.typicode.com")! // Prod
//    private static let baseAddress: URL = URL(string: "https://jsonplaceholder.typicode.com")! // Debug
